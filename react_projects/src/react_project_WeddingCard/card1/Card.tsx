...
export const Card = (props) => {
  ...
  return (
    <div className='flex items-center flex-col border border-black flex-1 overflow-auto'>
      <div className="m-1 relative text-7xl bg-no-repeat bg-cover border border-black" style={{ backgroundImage: `url(${cardBackground})` }}>
        <img className='w-[600px]' src={cardBackground}/>
        <div className='h-full absolute top-0 left-0 right-0 bottom-0 flex flex-col justify-center items-center gap-8'>
