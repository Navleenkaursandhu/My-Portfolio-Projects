...
export const MainCard = (props) => {
  return (
    <div className="relative">
      ...
      <div className='absolute  text-[#575353] top-0 left-0 right-0 bottom-0 flex flex-col justify-center items-center pl-[140px] pr-[140px] pt-[30px] border border-groove shadow-xl gap-[6px]'>
        <div className='text-[16px] font-semibold text-center flex flex-col items-center font-applyFont'>
          <div>
        ...
        {props.information.brideMotherName && <div className='text-[16px] text-center font-applyFont'>Joyfully invite you to celebrate the marriage of their children</div>}

        <div className='text-[26px] text-[#c7568e] text-center font-applyOnCard font-extrabold'>
          <div>{props.information.groomName}</div>
          {props.information.groomName && <div>&amp;</div>}
          <div>{props.information.brideName}</div>
        </div>

        <div className='text-[16px] font-applyFont flex'>
          ...
          <div className='flex items-center pl-[10px] pr-[10px] font-semibold text-[28px] border-r-2 border-slate-500'>{props.information.weddingDate && format(props.information.weddingDate, 'dd')}</div>
