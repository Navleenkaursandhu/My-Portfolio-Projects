...
export const Word = (props) => {
  ...
  return (
    <>
      <div className="lg:w-[44%] w-full lg:h-full flex flex-col bg-[#f4e8d8] bg-no-repeat bg-contain bg-bottom border-[10px] border-[#2c2f62] border-r-0" style={{ backgroundImage: `url(${image})` }}>
