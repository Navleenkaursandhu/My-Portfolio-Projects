        ...
        <div>
          ...
          <div className='flex gap-3 mt-4'>
            <div className='bg-indigo-500 shadow-[4px_4px_0px_0px_#4f46e5] font-bold  rounded-md px-2 py-1 text-white'>
              <a className='flex items-center gap-2 ' href={props.details.link} target='_blank' rel="noreferrer">View<span className="text-white material-symbols-rounded">
                open_in_new
              </span></a>
            </div>

            <div className='bg-indigo-500 shadow-[4px_4px_0px_0px_#4f46e5] font-bold rounded-md px-2 py-1 text-white'>
              <a className='flex items-center gap-2' href={props.details.githubLink} target='_blank' rel="noreferrer">GitHub
                <span>
