...
const projects = [
  {
    ...
    description: <div>
      <p>E-commerce has revolutionized the way we shop for products and services. Inspired by the various e-commerce websites
        ...
        Also, the graphic design for the entire website was initially done in Figma (<a target='_blank' rel="noreferrer" className='text-blue-600 underline underline-offset-2' href='https://www.figma.com/file/mXpZrdScuIiCUqgPkkuEbk/E-Commerce-Website-Design?node-id=0%3A1&t=QfpR8YUuQRm3nNzh-3'>see the design here</a>)</p>
