...
export const description = <div>
  Want to test your memory? -try out this famous memory game by repeating the same pattern played by the Simon.
  ...
  his turn (try remebering the order with blue flashes). When Simon is done, a text will display telling you
  ...
  you correctly match his flashes indicated by green color, you win the round. If you click out of order indicated by red, you loose.
</div>
