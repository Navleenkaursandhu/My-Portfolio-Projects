...
export const description = <div>
  ...
  ISO currency code. Exchange rates keep on fluctuating, and this live Currency Converter updates the exchange rate from an external <span className='text-violet-800'>&quot;API&quot;</span> making
