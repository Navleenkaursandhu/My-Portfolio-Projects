...
export const Main = () => {
  ...
  return (
    <div className="relative mt-[64px] mr-[auto] mb-[0px] ml-[auto] lg:w-1/2 md:w-3/5 w-4/5 font-applyPTSans">
      <div className='lg:h-[100px] lg:w-[100px] md:h-[94px] md:w-[94px] sm:h-[92px] sm:w-[92px] h-[60px] w-[60px] rounded-[50px] top-[-6%] left-[70%] lg:text-[64px] md:text-[64px] sm:text-[64px] text-[32px] bg-[#86f6d1] flex justify-center items-center absolute shadow-[2px_2px_3px_3px_#999899] '>¥</div>
      ...
      <div className="flex flex-col h-[600px] rounded-[14px] px-[0px] py-[60px] bg-slate-100 shadow-[2px_2px_2px_2px_#c1c2c4]">
        <div className='lg:text-4xl text-3xl text-center mt-[0px] mx-[0px] mb-[30px]'>CURRENCY CONVERTER</div>

        <div className='flex flex-col gap-[10px] mt-[30px] mb-[10px] mx-[50px] lg:text-3xl text-2xl'>
          <div>Amount</div>
          <input onChange={(e) => setUserInputVal(e.target.value)} className="lg:text-3xl text-2xl p-[10px] rounded-[4px]  shadow-[2px_2px_3px_3px_#c5c5c7]" placeholder='Enter amount to be converted here'></input>
        </div>

        <div className='flex justify-between mt-[30px] mr-[50px] mb-[0px] ml-[50px] lg:text-3xl text-2xl'>
          <div>From</div>
          <div>To</div>
        </div>

        <div className='flex items-center px-[0px] py-[10px] justify-between my-[0px] mx-[50px] lg:text-3xl text-2xl'>
          ...
          <span className="lg:text-3xl md:text-3xl text-2xl material-symbols-rounded">
            swap_horiz
          </span>

          <select onChange={(e) => displayDescriptionTo(e)} className='w-[44%] shadow-[2px_2px_3px_3px_#c5c5c7] p-[4px] lg:text-3xl text-2xl rounded-[4px]'>
            <option >Select</option>
            {keyArray.map((key, i) => {
        ...
        <div className='flex justify-between mt-[5px] mr-[50px] mb-[0px] ml-[50px] lg:text-3xl text-xl h-[44px]'>
          <div className='w-[44%]'>
        ...
        <div className='flex justify-center items-center mt-20 lg:gap-10 md:gap-8 sm:gap-4 gap-1 lg:text-3xl md:text-2xl text-xl rounded-[5px] '>
